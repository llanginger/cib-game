...
const textGameLevels: IWordGameLevel[] = [
    ...
    },
    {
        id: 1,
        headerText:
            "Sally got caught out in the rain without an umbrella, what should she think in order to remain COOL?",
    ...
    },
    {
        id: 2,
        headerText:
            "Frank dropped his icecream, how should he respond with a COOL thought?",
    ...
    },
    {
        id: 3,
        headerText:
            "Juliana is unhappy (HOT) that she has to do homework, what is she thinking?",
        bodyText: ["I", "homework!"],
        image: require("../../../images/studyPre.png"),
...
export const getTextGameLevel: (seenLevels: number[]) => IWordGameLevel = (
    seenLevels: number[]
) => {
