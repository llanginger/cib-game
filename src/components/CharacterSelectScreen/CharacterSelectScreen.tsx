...
import { makeUserAvatars } from "./makeUserAvatars";
import { CharacterSelectTitle } from "./CharacterSelectTitle";
...
export const CharacterSelectScreen = connect(mapStateToProps)(_CharacterSelect);
