    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                >
                    <Text style={styles.menuItemText}>Protagonistas</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.menuItem, { backgroundColor: "#3333cc" }]}
                    onPress={() => {
                        this.props.navigator.showModal({
                            screen: "SkillRecapScreen", // unique ID registered with Navigation.registerScreen
                            title: "Modal", // title of the screen as appears in the nav bar (optional)
                            passProps: {}, // simple serializable object that will pass as props to the modal (optional)
                            navigatorStyle: {}, // override the navigator style for the screen, see "Styling the navigator" below (optional)
                            animationType: "slide-up", // 'none' / 'slide-up' , appear animation for the modal (optional, default 'slide-up')
                ...
                >
                    <Text style={styles.menuItemText}>Las 6 Habilidades</Text>
                </TouchableOpacity>
                <TouchableOpacity
